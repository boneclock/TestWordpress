<?php
/**
 * The header of Mega Test Theme
 *
 * Displays all <head> section and everything till the main content of the site
 *
 * @package Mega Test
 * @since Mega Test 0.1
 */
...
<head>
    ...
    <title>
        ...
        if( $paged >= 2 || $page >= 2)
            echo ' | ' . sprintf(__('Page %s', 'mega_test'), max($paged,$page));
        ?>
    </title>
